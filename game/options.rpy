...
define config.name = _("Der Fluch von Scheuerhof")


## Deutsch ist die Standardsprache des Spiels (Original-Skript ist auf
## Deutsch geschrieben). Zusätzlich verfügbar: Englisch, Französisch,
## Luxemburgisch (siehe game/tl/).
define config.default_language = "german"
...
define gui.about = _("""Eine Visual Novel über den Scheuerhof im Wald von Nohn.
...
init python:
    ...
    ## Der Projektordner enthält das Ren'Py-SDK, alte Build-Ausgaben und
    ...
    ## tools/ enthält Python-Tooling zur Audio-Generierung (inkl. venvs mit
    ## Torch, mehrere GB) - gehört nicht in die Spiel-Distribution.
    build.classify('tools/**', None)

    ## valkyrie-quest/ ist ein unabhängiges VTT-Projekt, das zufällig als
    ## Geschwisterordner hier liegt - gehört ebenfalls nicht ins Spiel.
    build.classify('valkyrie-quest/**', None)
...
# define build.itch_project = "username/scheuerhof"
